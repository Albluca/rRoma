...
It is possible to explore interactivelly the results of the ananlysis via two interactive dashboards:
...
In this example we will use the cell cycle map and therefore we will recompute ROMA on genesets that are cell cycle related.
