...
sufficient write:
    ...
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.7729627544363 L1/L2 = 20.467490731362"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.449933099557887 L1/L2 = 2.64396512654145"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.312869371176746 L1/L2 = 3.0241726274242"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.548975364887349 L1/L2 = 7.97282092986273"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.255165830617036 L1/L2 = 1.16752788619148"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.119095347645235 L1/L2 = 1.1650998069932"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.338120066940927 L1/L2 = 1.4448348256302"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.199225330240566 L1/L2 = 2.26150080467697"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.239386323116417 L1/L2 = 1.43036782780462"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.337501748834406 L1/L2 = 2.96115713031046"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.214760028792223 L1/L2 = 1.68937913401953"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.200668700874952 L1/L2 = 1.27417289768289"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.164050747781322 L1/L2 = 1.2415807660914"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.168009604183691 L1/L2 = 1.60374558650177"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.149390754163709 L1/L2 = 1.22768898584236"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.148131583879507 L1/L2 = 1.52689537632271"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.164299689983162 L1/L2 = 1.31014946513075"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.349357632349227 L1/L2 = 3.50341844237098"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.203202106002461 L1/L2 = 1.75814950477538"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.208166533754724 L1/L2 = 2.53249280285996"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.35608633110885 L1/L2 = 2.17293869871241"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.30587705426011 L1/L2 = 1.43079797937075"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.210680155652854 L1/L2 = 2.2890879631088"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.218055002765523 L1/L2 = 1.54817118220201"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.361582725735916 L1/L2 = 2.44824727076752"
    ...
    ## [1] "Not using weigths for PCA computation"
    ## [1] "Pre-filter data"
    ## [1] "L1 = 0.430033039712537 L1/L2 = 2.71526720581971"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.186298198027508 L1/L2 = 2.11788331971069"
    ...
    ## [1] "Post-filter data"
    ## [1] "L1 = 0.338572405035907 L1/L2 = 1.97568150193547"
...
-------------------
    ...
    ## [16] ggsignif_0.2.0       colorspace_1.3-2     htmltools_0.3.6     
    ## [19] httpuv_1.3.3         Matrix_1.2-10        plyr_1.8.4          
    ## [22] XML_3.98-1.7         pheatmap_1.0.8       biomaRt_2.30.0      
    ## [25] zlibbioc_1.20.0      xtable_1.8-2         scales_0.4.1        
    ## [28] tibble_1.3.0         IRanges_2.8.2        tictoc_1.0          
    ## [31] ggplot2_2.2.1        lazyeval_0.2.0       RJSONIO_1.3-0       
    ## [34] magrittr_1.5         mime_0.5             memoise_1.1.0       
    ## [37] evaluate_0.10        MASS_7.3-45          beeswarm_0.2.3      
    ## [40] shinydashboard_0.5.3 tools_3.3.3          scater_1.2.0        
    ## [43] data.table_1.10.4    hms_0.3              matrixStats_0.52.2  
    ## [46] stringr_1.2.0        S4Vectors_0.12.2     munsell_0.4.3       
    ## [49] locfit_1.5-9.1       irlba_2.1.2          AnnotationDbi_1.36.2
    ## [52] colorRamps_2.3       rhdf5_2.18.0         grid_3.3.3          
    ## [55] RCurl_1.95-4.8       tximport_1.2.0       rjson_0.2.15        
    ## [58] bitops_1.0-6         labeling_0.3         rmarkdown_1.5       
    ## [61] gtable_0.2.0         DBI_0.6-1            reshape_0.8.6       
    ## [64] curl_2.6             reshape2_1.4.2       R6_2.2.0            
    ## [67] gridExtra_2.2.1      knitr_1.15.1         dplyr_0.5.0         
    ## [70] rprojroot_1.2        RNaviCell_0.2.1      stringi_1.1.5       
    ## [73] ggbeeswarm_0.5.3     Rcpp_0.12.10
